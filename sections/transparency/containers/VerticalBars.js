    ...
    return (
        <section className="verticalBar-section">
            ...
            <div className="graphics-container">
              <Details currentLang={this.props.currentLang} subtitle={t('transparency.barGraphic.income.subtitle')}/>
              <DetailOutcome currentLang={this.props.currentLang} subtitle={t('transparency.barGraphic.outcome.subtitle')}/>
            </div>
