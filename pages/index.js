  ...
  componentDidMount() {
    ...
    if (isSubscribed !== undefined) {
      this.setState({
        ...
        content:
          isSubscribed === "true"
            ? "Ya estás subscripto a Democracia en Red. ¡Pronto recibirás novedades!"
            : "Link inválido, asegurate de validar el link antes de dos días y de utilizar el link del último mail de confirmación",
      });
    }
  }
        ...
        >
          ...
          <Link href={"/vivo"}>
            <div className="header-streamings">
              <img
                src="/static/assets/live/der-live-logo.svg"
                className="der-live-logo"
              />
            </div>
          </Link>
          <Collaborate />
